...
export default async function WordDetectivePage({ params, searchParams }: Props) {
  ...
  if (!user) redirect(`/login?next=${encodeURIComponent(`/courses/${course.slug}/classic-word-quest/word-detective${targetQuery}`)}`);
